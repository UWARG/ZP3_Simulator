...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 2450018432;
  checksumData[1] = 2665618099;
  checksumData[2] = 2861501132;
  checksumData[3] = 2473462278;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 2137405304;
    checksumData[1] = 830904895;
    checksumData[2] = 1499352801;
    checksumData[3] = 1598091403;
...

  {
    ...
    checksumData[0] = 3749457986;
    checksumData[1] = 897066280;
    checksumData[2] = 3855214685;
    checksumData[3] = 637709802;
...

  {
    ...
    checksumData[0] = 3612403725;
    checksumData[1] = 1707952061;
    checksumData[2] = 3509317884;
    checksumData[3] = 1068273947;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "aGBga77kZPMrtPrVD39RKE") == 0) {
    extern mxArray *cgxe_aGBga77kZPMrtPrVD39RKE_BuildInfoUpdate(void);
    plhs[0] = cgxe_aGBga77kZPMrtPrVD39RKE_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "aGBga77kZPMrtPrVD39RKE") == 0) {
    extern mxArray *cgxe_aGBga77kZPMrtPrVD39RKE_fallback_info(void);
    plhs[0] = cgxe_aGBga77kZPMrtPrVD39RKE_fallback_info();
    return 1;
  }
