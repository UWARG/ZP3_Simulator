...
#include "m_GZlcI4guxfAkufEiivXUQG.hpp"
...
static void cgxe_mdl_start(InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_GZlcI4guxfAkufEiivXUQG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_GZlcI4guxfAkufEiivXUQG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_GZlcI4guxfAkufEiivXUQG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_GZlcI4guxfAkufEiivXUQG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_GZlcI4guxfAkufEiivXUQG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_GZlcI4guxfAkufEiivXUQG
  *moduleInstance);
static void init_simulink_io_address(InstanceStruct_GZlcI4guxfAkufEiivXUQG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_GZlcI4guxfAkufEiivXUQG(SimStruct *S, int_T tid)
{
  InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance =
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_GZlcI4guxfAkufEiivXUQG(SimStruct *S)
{
  InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance =
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_GZlcI4guxfAkufEiivXUQG(SimStruct *S, int_T tid)
{
  InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance =
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_GZlcI4guxfAkufEiivXUQG(SimStruct *S)
{
  InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance =
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_GZlcI4guxfAkufEiivXUQG(SimStruct *S)
{
  InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance =
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_GZlcI4guxfAkufEiivXUQG(SimStruct *S)
{
  InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance =
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_GZlcI4guxfAkufEiivXUQG(SimStruct *S)
{
  InstanceStruct_GZlcI4guxfAkufEiivXUQG *moduleInstance =
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG *)calloc(1, sizeof
    (InstanceStruct_GZlcI4guxfAkufEiivXUQG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_GZlcI4guxfAkufEiivXUQG);
  ssSetmdlInitializeConditions(S, mdlInitialize_GZlcI4guxfAkufEiivXUQG);
  ssSetmdlUpdate(S, mdlUpdate_GZlcI4guxfAkufEiivXUQG);
  ssSetmdlTerminate(S, mdlTerminate_GZlcI4guxfAkufEiivXUQG);
  ssSetmdlEnable(S, mdlEnable_GZlcI4guxfAkufEiivXUQG);
  ssSetmdlDisable(S, mdlDisable_GZlcI4guxfAkufEiivXUQG);
...
static void mdlProcessParameters_GZlcI4guxfAkufEiivXUQG(SimStruct *S)
{
}

void method_dispatcher_GZlcI4guxfAkufEiivXUQG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_GZlcI4guxfAkufEiivXUQG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_GZlcI4guxfAkufEiivXUQG(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: GZlcI4guxfAkufEiivXUQG.\n"
...
mxArray *cgxe_GZlcI4guxfAkufEiivXUQG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_GZlcI4guxfAkufEiivXUQG_fallback_info(void)
{
