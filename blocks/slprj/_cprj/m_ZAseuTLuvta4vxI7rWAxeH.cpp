...
#include "m_ZAseuTLuvta4vxI7rWAxeH.hpp"
...
static void cgxe_mdl_start(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH
  *moduleInstance);
static void init_simulink_io_address(InstanceStruct_ZAseuTLuvta4vxI7rWAxeH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S, int_T tid)
{
  InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance =
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S)
{
  InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance =
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S, int_T tid)
{
  InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance =
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S)
{
  InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance =
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S)
{
  InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance =
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S)
{
  InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance =
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S)
{
  InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *moduleInstance =
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH *)calloc(1, sizeof
    (InstanceStruct_ZAseuTLuvta4vxI7rWAxeH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_ZAseuTLuvta4vxI7rWAxeH);
  ssSetmdlInitializeConditions(S, mdlInitialize_ZAseuTLuvta4vxI7rWAxeH);
  ssSetmdlUpdate(S, mdlUpdate_ZAseuTLuvta4vxI7rWAxeH);
  ssSetmdlTerminate(S, mdlTerminate_ZAseuTLuvta4vxI7rWAxeH);
  ssSetmdlEnable(S, mdlEnable_ZAseuTLuvta4vxI7rWAxeH);
  ssSetmdlDisable(S, mdlDisable_ZAseuTLuvta4vxI7rWAxeH);
...
static void mdlProcessParameters_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S)
{
}

void method_dispatcher_ZAseuTLuvta4vxI7rWAxeH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_ZAseuTLuvta4vxI7rWAxeH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_ZAseuTLuvta4vxI7rWAxeH(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: ZAseuTLuvta4vxI7rWAxeH.\n"
...
mxArray *cgxe_ZAseuTLuvta4vxI7rWAxeH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_ZAseuTLuvta4vxI7rWAxeH_fallback_info(void)
{
