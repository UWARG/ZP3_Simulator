...
#define __MW_INSTRUM_RECORD_COMBINATION_HIT_2() \
  __MW_INSTRUM_RECORD_HIT(76U + __mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_2)

#define __MW_INSTRUM_NODE_6(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(6U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_2 = 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(7U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_2 = 0U), (0 == 1)))
#define __MW_INSTRUM_NODE_10(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(10U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_2 += 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(11U), (0 == 1)))
#define __MW_INSTRUM_NODE_14(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(14U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_2 += 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(15U), (0 == 1)))
...
#define __MW_INSTRUM_RECORD_COMBINATION_HIT_21() \
  __MW_INSTRUM_RECORD_HIT(80U + __mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_21)

#define __MW_INSTRUM_NODE_27(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(27U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_21 = 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(28U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_21 = 0U), (0 == 1)))
#define __MW_INSTRUM_NODE_31(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(31U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_21 += 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(32U), (0 == 1)))
#define __MW_INSTRUM_NODE_35(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(35U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_21 += 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(36U), (0 == 1)))
#define __MW_INSTRUM_NODE_21(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(21U), __MW_INSTRUM_RECORD_COMBINATION_HIT_21(), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(22U), __MW_INSTRUM_RECORD_COMBINATION_HIT_21(), (0 == 1)))

#define __MW_INSTRUM_RECORD_COMBINATION_HIT_49() \
  __MW_INSTRUM_RECORD_HIT(84U + __mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_49)

#define __MW_INSTRUM_NODE_55(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(55U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_49 = 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(56U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_49 = 0U), (0 == 1)))
#define __MW_INSTRUM_NODE_59(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(59U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_49 += 1U), (1 == 1)) :\
   (__MW_INSTRUM_RECORD_HIT(60U), (0 == 1)))
#define __MW_INSTRUM_NODE_63(...) \
  ((__VA_ARGS__) ?\
   (__MW_INSTRUM_RECORD_HIT(63U), (__mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_49 += 1U), (1 == 1)) :\
...
#define __MW_INSTRUM_FCN_ENTER_1() \
  unsigned int __mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_2 = 0U; \
  unsigned int __mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_21 = 0U; 
#define __MW_INSTRUM_FCN_ENTER_2() \
  unsigned int __mw_instrum_ryVt94VYknNXY4wP2WoELF_cclib_curr_combination_idx_49 = 0U; 
...
#define __MW_INSTRUM_NODE_8(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(8U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(9U) : (void)0)))
#define __MW_INSTRUM_NODE_12(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(12U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(13U) : (void)0)))
#define __MW_INSTRUM_NODE_16(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(16U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(17U) : (void)0)))
...
#define __MW_INSTRUM_NODE_29(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(29U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(30U) : (void)0)))
#define __MW_INSTRUM_NODE_33(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(33U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(34U) : (void)0)))
#define __MW_INSTRUM_NODE_37(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(37U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(38U) : (void)0)))
...
#define __MW_INSTRUM_NODE_44(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) <= (rhs)) ? __MW_INSTRUM_RECORD_HIT(44U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(45U) : (void)0)))
#define __MW_INSTRUM_NODE_43() (__MW_INSTRUM_RECORD_HIT(43U))
#define __MW_INSTRUM_NODE_46() (__MW_INSTRUM_RECORD_HIT(46U))
#define __MW_INSTRUM_NODE_47() (__MW_INSTRUM_RECORD_HIT(47U))
#define __MW_INSTRUM_NODE_48() (__MW_INSTRUM_RECORD_HIT(48U))
#define __MW_INSTRUM_NODE_51(...) ((__VA_ARGS__) ? (__MW_INSTRUM_RECORD_HIT(51U), (1 == 1)) : (__MW_INSTRUM_RECORD_HIT(52U), (0 == 1)))
#define __MW_INSTRUM_NODE_53(...) ((__VA_ARGS__) ? (__MW_INSTRUM_RECORD_HIT(53U), (1 == 1)) : (__MW_INSTRUM_RECORD_HIT(54U), (0 == 1)))
#define __MW_INSTRUM_NODE_57(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(57U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(58U) : (void)0)))
#define __MW_INSTRUM_NODE_61(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(61U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(62U) : (void)0)))
#define __MW_INSTRUM_NODE_65(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) < (rhs)) ? __MW_INSTRUM_RECORD_HIT(65U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(66U) : (void)0)))
#define __MW_INSTRUM_NODE_67() (__MW_INSTRUM_RECORD_HIT(67U))
#define __MW_INSTRUM_NODE_68(...) ((__VA_ARGS__) ? (__MW_INSTRUM_RECORD_HIT(68U), (1 == 1)) : (__MW_INSTRUM_RECORD_HIT(69U), (0 == 1)))
#define __MW_INSTRUM_NODE_70(lhs, rhs) ((((lhs) >= (rhs) - __MW_INSTRUM_TOL((lhs), (rhs)) && (lhs) <= (rhs)) ? __MW_INSTRUM_RECORD_HIT(70U) : (((lhs) > (rhs) && (lhs) <= (rhs) + __MW_INSTRUM_TOL((lhs), (rhs))) ? __MW_INSTRUM_RECORD_HIT(71U) : (void)0)))
#define __MW_INSTRUM_NODE_69() (__MW_INSTRUM_RECORD_HIT(69U))
#define __MW_INSTRUM_NODE_72() (__MW_INSTRUM_RECORD_HIT(72U))
#define __MW_INSTRUM_NODE_73() (__MW_INSTRUM_RECORD_HIT(73U))
#define __MW_INSTRUM_NODE_74() (__MW_INSTRUM_RECORD_HIT(74U))
#define __MW_INSTRUM_NODE_75() (__MW_INSTRUM_RECORD_HIT(75U))
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_6CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_6(...) (__MW_INSTRUM_RECORD_HIT_6CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_6(exp) (__MW_INSTRUM_RECORD_HIT_6CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_10CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_10(...) (__MW_INSTRUM_RECORD_HIT_10CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_10(exp) (__MW_INSTRUM_RECORD_HIT_10CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_14CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_14(...) (__MW_INSTRUM_RECORD_HIT_14CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_14(exp) (__MW_INSTRUM_RECORD_HIT_14CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_2DAA_6_10_14Z_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_2(...) (__MW_INSTRUM_RECORD_HIT_2DAA_6_10_14Z_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_2(exp) (__MW_INSTRUM_RECORD_HIT_2DAA_6_10_14Z_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_27CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_27(...) (__MW_INSTRUM_RECORD_HIT_27CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_27(exp) (__MW_INSTRUM_RECORD_HIT_27CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_31CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_31(...) (__MW_INSTRUM_RECORD_HIT_31CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_31(exp) (__MW_INSTRUM_RECORD_HIT_31CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_35CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_35(...) (__MW_INSTRUM_RECORD_HIT_35CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_35(exp) (__MW_INSTRUM_RECORD_HIT_35CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_21DNAA_27_31_35Z_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_21(...) (__MW_INSTRUM_RECORD_HIT_21DNAA_27_31_35Z_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_21(exp) (__MW_INSTRUM_RECORD_HIT_21DNAA_27_31_35Z_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_55CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_55(...) (__MW_INSTRUM_RECORD_HIT_55CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_55(exp) (__MW_INSTRUM_RECORD_HIT_55CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_59CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_59(...) (__MW_INSTRUM_RECORD_HIT_59CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_59(exp) (__MW_INSTRUM_RECORD_HIT_59CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_63CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_63(...) (__MW_INSTRUM_RECORD_HIT_63CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_63(exp) (__MW_INSTRUM_RECORD_HIT_63CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
#ifdef __cplusplus
extern "C"
#else
extern
#endif
int __MW_INSTRUM_RECORD_HIT_49DNAA_55_59_63Z_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_49(...) (__MW_INSTRUM_RECORD_HIT_49DNAA_55_59_63Z_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_49(exp) (__MW_INSTRUM_RECORD_HIT_49DNAA_55_59_63Z_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_1EZ_ryVt94VYknNXY4wP2WoELF(void) { }
#define __MW_INSTRUM_NODE_1() __MW_INSTRUM_RECORD_HIT_1EZ_ryVt94VYknNXY4wP2WoELF()
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_4CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_4(...) (__MW_INSTRUM_RECORD_HIT_4CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_4(exp) (__MW_INSTRUM_RECORD_HIT_4CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_8FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_8(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_8FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_12FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_12(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_12FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_16FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_16(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_16FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_19XZ_ryVt94VYknNXY4wP2WoELF(void) { }
#define __MW_INSTRUM_NODE_19() __MW_INSTRUM_RECORD_HIT_19XZ_ryVt94VYknNXY4wP2WoELF()
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_23CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_23(...) (__MW_INSTRUM_RECORD_HIT_23CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_23(exp) (__MW_INSTRUM_RECORD_HIT_23CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_25CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_25(...) (__MW_INSTRUM_RECORD_HIT_25CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_25(exp) (__MW_INSTRUM_RECORD_HIT_25CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_29FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_29(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_29FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_33FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_33(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_33FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_37FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_37(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_37FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_42DZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_42(...) (__MW_INSTRUM_RECORD_HIT_42DZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_42(exp) (__MW_INSTRUM_RECORD_HIT_42DZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_44FGTZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_44(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_44FGTZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_47XZ_ryVt94VYknNXY4wP2WoELF(void) { }
#define __MW_INSTRUM_NODE_47() __MW_INSTRUM_RECORD_HIT_47XZ_ryVt94VYknNXY4wP2WoELF()
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_48EZ_ryVt94VYknNXY4wP2WoELF(void) { }
#define __MW_INSTRUM_NODE_48() __MW_INSTRUM_RECORD_HIT_48EZ_ryVt94VYknNXY4wP2WoELF()
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_51CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_51(...) (__MW_INSTRUM_RECORD_HIT_51CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_51(exp) (__MW_INSTRUM_RECORD_HIT_51CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_53CZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_53(...) (__MW_INSTRUM_RECORD_HIT_53CZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_53(exp) (__MW_INSTRUM_RECORD_HIT_53CZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_57FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_57(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_57FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_61FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_61(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_61FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_65FEQZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_65(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_65FEQZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_68DZ_ryVt94VYknNXY4wP2WoELF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_68(...) (__MW_INSTRUM_RECORD_HIT_68DZ_ryVt94VYknNXY4wP2WoELF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_68(exp) (__MW_INSTRUM_RECORD_HIT_68DZ_ryVt94VYknNXY4wP2WoELF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_70FGTZ_ryVt94VYknNXY4wP2WoELF(double lhs, double rhs) { }
#define __MW_INSTRUM_NODE_70(lhs, rhs) (__MW_INSTRUM_RECORD_HIT_70FGTZ_ryVt94VYknNXY4wP2WoELF(lhs, rhs))
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_73XZ_ryVt94VYknNXY4wP2WoELF(void) { }
#define __MW_INSTRUM_NODE_73() __MW_INSTRUM_RECORD_HIT_73XZ_ryVt94VYknNXY4wP2WoELF()
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_74EZ_ryVt94VYknNXY4wP2WoELF(void) { }
#define __MW_INSTRUM_NODE_74() __MW_INSTRUM_RECORD_HIT_74EZ_ryVt94VYknNXY4wP2WoELF()
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_75XZ_ryVt94VYknNXY4wP2WoELF(void) { }
#define __MW_INSTRUM_NODE_75() __MW_INSTRUM_RECORD_HIT_75XZ_ryVt94VYknNXY4wP2WoELF()


#endif /* __MW_INTERNAL_SLDV_PS_ANALYSIS__ */

#line 1 "C:\\Users\\mahus\\Desktop\\WARG_NEW\\ZP3-Simulator\\sensor_fusion\\Src\\manhony_ahrs.cpp"
...
#line 31 "C:\\Users\\mahus\\Desktop\\WARG_NEW\\ZP3-Simulator\\sensor_fusion\\Src\\manhony_ahrs.cpp"
volatile float twoKp = ((2.0F) * (.5F)); 
volatile float twoKi = ((2.0F) * (0.1F)); 
...
#line 47
void MahonyAHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) { __MW_INSTRUM_FCN_ENTER_1(); __MW_INSTRUM_NODE_1(); 
float recipNorm; 
...
if (__MW_INSTRUM_NODE_2((__MW_INSTRUM_NODE_4((__MW_INSTRUM_NODE_6((__MW_INSTRUM_NODE_8(mx, (0.0F)), (mx == (0.0F))))) && (__MW_INSTRUM_NODE_10((__MW_INSTRUM_NODE_12(my, (0.0F)), (my == (0.0F))))))) && (__MW_INSTRUM_NODE_14((__MW_INSTRUM_NODE_16(mz, (0.0F)), (mz == (0.0F))))))) { 
__MW_INSTRUM_NODE_18(), MahonyAHRSupdateIMU(gx, gy, gz, ax, ay, az); __MW_INSTRUM_NODE_19(); 
return; 
}  __MW_INSTRUM_NODE_20(); 


if (__MW_INSTRUM_NODE_21(!__MW_INSTRUM_NODE_23((__MW_INSTRUM_NODE_25((__MW_INSTRUM_NODE_27((__MW_INSTRUM_NODE_29(ax, (0.0F)), (ax == (0.0F))))) && (__MW_INSTRUM_NODE_31((__MW_INSTRUM_NODE_33(ay, (0.0F)), (ay == (0.0F))))))) && (__MW_INSTRUM_NODE_35((__MW_INSTRUM_NODE_37(az, (0.0F)), (az == (0.0F)))))))) { 


recipNorm = (__MW_INSTRUM_NODE_39(), invSqrt((ax * ax + ay * ay) + az * az)); 
ax = ax * recipNorm; 
ay = ay * recipNorm; 
az = az * recipNorm; 


recipNorm = (__MW_INSTRUM_NODE_40(), invSqrt((mx * mx + my * my) + mz * mz)); 
mx = mx * recipNorm; 
my = my * recipNorm; 
mz = mz * recipNorm; 
...
bx = (__MW_INSTRUM_NODE_41(), sqrt(hx * hx + hy * hy)); 
...
if (__MW_INSTRUM_NODE_42((__MW_INSTRUM_NODE_44(twoKi, (0.0F)), (twoKi > (0.0F))))) { 
integralFBx = integralFBx + (twoKi * halfex) * ((1.0F) / SF_FREQ); 
integralFBy = integralFBy + (twoKi * halfey) * ((1.0F) / SF_FREQ); 
integralFBz = integralFBx + (twoKi * halfez) * ((1.0F) / SF_FREQ); 
gx += integralFBx; 
gy += integralFBy; 
gz += integralFBz; 
} else 
...
gx *= (0.5F) * ((1.0F) / SF_FREQ); 
gy *= (0.5F) * ((1.0F) / SF_FREQ); 
gz *= (0.5F) * ((1.0F) / SF_FREQ); 
qa = q0; 
qb = q1; 
qc = q2; 
...
recipNorm = (__MW_INSTRUM_NODE_46(), invSqrt(((q0 * q0 + q1 * q1) + q2 * q2) + q3 * q3)); 
q0 = q0 * recipNorm; 
q1 = q1 * recipNorm; 
q2 = q2 * recipNorm; 
q3 = q3 * recipNorm; __MW_INSTRUM_NODE_47(); 
} 




void MahonyAHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, float az) { __MW_INSTRUM_FCN_ENTER_2(); __MW_INSTRUM_NODE_48(); 
float recipNorm; 
...
if (__MW_INSTRUM_NODE_49(!__MW_INSTRUM_NODE_51((__MW_INSTRUM_NODE_53((__MW_INSTRUM_NODE_55((__MW_INSTRUM_NODE_57(ax, (0.0F)), (ax == (0.0F))))) && (__MW_INSTRUM_NODE_59((__MW_INSTRUM_NODE_61(ay, (0.0F)), (ay == (0.0F))))))) && (__MW_INSTRUM_NODE_63((__MW_INSTRUM_NODE_65(az, (0.0F)), (az == (0.0F)))))))) { 


recipNorm = (__MW_INSTRUM_NODE_67(), invSqrt((ax * ax + ay * ay) + az * az)); 
ax *= recipNorm; 
ay *= recipNorm; 
az *= recipNorm; 
...
if (__MW_INSTRUM_NODE_68((__MW_INSTRUM_NODE_70(twoKi, (0.0F)), (twoKi > (0.0F))))) { 
integralFBx = integralFBx + (twoKi * halfex) * ((1.0F) / SF_FREQ); 
integralFBy = integralFBy + (twoKi * halfey) * ((1.0F) / SF_FREQ); 
integralFBz = integralFBz + (twoKi * halfez) * ((1.0F) / SF_FREQ); 
gx = gx + integralFBx; 
gy = gy + integralFBy; 
gz = gz + integralFBz; 
} else 
...
gx = gx * ((0.5F) * ((1.0F) / SF_FREQ)); 
gy = gy * ((0.5F) * ((1.0F) / SF_FREQ)); 
gz = gz * ((0.5F) * ((1.0F) / SF_FREQ)); 
qa = q0; 
qb = q1; 
qc = q2; 
q0 = q0 + ((-qb * gx - qc * gy) - q3 * gz); 
...
recipNorm = (__MW_INSTRUM_NODE_72(), invSqrt(((q0 * q0 + q1 * q1) + q2 * q2) + q3 * q3)); 
q0 = q0 * recipNorm; 
q1 = q1 * recipNorm; 
q2 = q2 * recipNorm; 
q3 = q3 * recipNorm; __MW_INSTRUM_NODE_73(); 
} 
#line 221
float invSqrt(float x) { __MW_INSTRUM_FCN_ENTER_3(); __MW_INSTRUM_NODE_74(); 
float halfx = (0.5F) * x; 
float y = x; 
long i = *((long *)(&y)); 
i = (0x5f3759df) - (i >> 1); 
y = *((float *)(&i)); 
y = y * ((1.5F) - (halfx * y) * y); 
{ float __mw_tmp_for_return = y; __MW_INSTRUM_NODE_75(); return __mw_tmp_for_return; } 
} 
