...
#include "m_OvHhA05jCX3lKcCeofTRNB.h"
...
static void cgxe_mdl_start(InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_OvHhA05jCX3lKcCeofTRNB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_OvHhA05jCX3lKcCeofTRNB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_OvHhA05jCX3lKcCeofTRNB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_OvHhA05jCX3lKcCeofTRNB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_OvHhA05jCX3lKcCeofTRNB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_OvHhA05jCX3lKcCeofTRNB
  *moduleInstance);
static void set_twoKi_val_Ot0CAsNmzP502AtDFUhkED_OOP
  (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance, const volatile
   real32_T *r);
static void set_twoKp_val_Ot0CAsNmzP502AtDFUhkED_OOP
  (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance, const volatile
   real32_T *r);
static SFError_t SF_GenerateNewResult_Ot0CAsNmzP502AtDFUhkED_OOP
  (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance, IMU_Data_t *r,
   Gps_Data_t *r1, Altimeter_Data_t *r2, SFIterationData_t *r3, SFOutput_t *r4);
static void init_simulink_io_address(InstanceStruct_OvHhA05jCX3lKcCeofTRNB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_OvHhA05jCX3lKcCeofTRNB(SimStruct *S, int_T tid)
{
  InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance =
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_OvHhA05jCX3lKcCeofTRNB(SimStruct *S)
{
  InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance =
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_OvHhA05jCX3lKcCeofTRNB(SimStruct *S, int_T tid)
{
  InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance =
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_OvHhA05jCX3lKcCeofTRNB(SimStruct *S)
{
  InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance =
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_OvHhA05jCX3lKcCeofTRNB(SimStruct *S)
{
  InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance =
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_OvHhA05jCX3lKcCeofTRNB(SimStruct *S)
{
  InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance =
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_OvHhA05jCX3lKcCeofTRNB(SimStruct *S)
{
  InstanceStruct_OvHhA05jCX3lKcCeofTRNB *moduleInstance =
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB *)calloc(1, sizeof
    (InstanceStruct_OvHhA05jCX3lKcCeofTRNB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_OvHhA05jCX3lKcCeofTRNB);
  ssSetmdlInitializeConditions(S, mdlInitialize_OvHhA05jCX3lKcCeofTRNB);
  ssSetmdlUpdate(S, mdlUpdate_OvHhA05jCX3lKcCeofTRNB);
  ssSetmdlTerminate(S, mdlTerminate_OvHhA05jCX3lKcCeofTRNB);
  ssSetmdlEnable(S, mdlEnable_OvHhA05jCX3lKcCeofTRNB);
  ssSetmdlDisable(S, mdlDisable_OvHhA05jCX3lKcCeofTRNB);
...
static void mdlProcessParameters_OvHhA05jCX3lKcCeofTRNB(SimStruct *S)
{
}

void method_dispatcher_OvHhA05jCX3lKcCeofTRNB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_OvHhA05jCX3lKcCeofTRNB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_OvHhA05jCX3lKcCeofTRNB(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: OvHhA05jCX3lKcCeofTRNB.\n"
...
mxArray *cgxe_OvHhA05jCX3lKcCeofTRNB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_OvHhA05jCX3lKcCeofTRNB_fallback_info(void)
{
