...
static void cgxe_mdl_start(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B
  *moduleInstance);
static void init_simulink_io_address(InstanceStruct_ykRtzkq0GdAszoujIhoJ2B
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  *moduleInstance->twoKi = *moduleInstance->u5;
  *moduleInstance->twoKp = *moduleInstance->u6;
  r = SF_GenerateNewResult_UUHv1SNmCc7CQ4dPO46XC(&local, &b_local, &c_local,
    &d_local, &e_local);
  ...
  *moduleInstance)
{
  ...
  moduleInstance->y5 = (SFOutput_t *)cgxertGetOutputPortSignal(moduleInstance->S,
    5);
  get_twoKi_addr_UUHv1SNmCc7CQ4dPO46XC(&moduleInstance->twoKi);
  get_twoKp_addr_UUHv1SNmCc7CQ4dPO46XC(&moduleInstance->twoKp);
}

/* CGXE Glue Code */
static void mdlOutputs_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S, int_T tid)
{
  InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance =
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S)
{
  InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance =
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S, int_T tid)
{
  InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance =
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S)
{
  InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance =
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S)
{
  InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance =
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S)
{
  InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance =
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S)
{
  InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *moduleInstance =
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B *)calloc(1, sizeof
    (InstanceStruct_ykRtzkq0GdAszoujIhoJ2B));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_ykRtzkq0GdAszoujIhoJ2B);
  ssSetmdlInitializeConditions(S, mdlInitialize_ykRtzkq0GdAszoujIhoJ2B);
  ssSetmdlUpdate(S, mdlUpdate_ykRtzkq0GdAszoujIhoJ2B);
  ssSetmdlTerminate(S, mdlTerminate_ykRtzkq0GdAszoujIhoJ2B);
  ssSetmdlEnable(S, mdlEnable_ykRtzkq0GdAszoujIhoJ2B);
  ssSetmdlDisable(S, mdlDisable_ykRtzkq0GdAszoujIhoJ2B);
...
static void mdlProcessParameters_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S)
{
}

void method_dispatcher_ykRtzkq0GdAszoujIhoJ2B(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_ykRtzkq0GdAszoujIhoJ2B(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_ykRtzkq0GdAszoujIhoJ2B(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: ykRtzkq0GdAszoujIhoJ2B.\n"
...
mxArray *cgxe_ykRtzkq0GdAszoujIhoJ2B_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_ykRtzkq0GdAszoujIhoJ2B_fallback_info(void)
{
