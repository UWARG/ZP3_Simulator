...
DLL_EXPORT_CC extern SFError_t SF_Init_3e0VqVpGhX4r1zmpJo3iYG(SFIterationData_t *iterData);
DLL_EXPORT_CC extern SFError_t SF_GenerateNewResult_3e0VqVpGhX4r1zmpJo3iYG(IMU_Data_t *imuData, Gps_Data_t *GpsData, Altimeter_Data_t *altimeterData, SFIterationData_t *iterData, SFOutput_t *SFoutput);
