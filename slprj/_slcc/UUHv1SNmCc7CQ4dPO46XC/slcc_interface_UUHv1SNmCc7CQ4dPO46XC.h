...
DLL_EXPORT_CC extern SFError_t SF_Init_UUHv1SNmCc7CQ4dPO46XC(SFIterationData_t *iterData);
DLL_EXPORT_CC extern SFError_t SF_GenerateNewResult_UUHv1SNmCc7CQ4dPO46XC(IMU_Data_t *imuData, Gps_Data_t *GpsData, Altimeter_Data_t *altimeterData, SFIterationData_t *iterData, SFOutput_t *SFoutput);
