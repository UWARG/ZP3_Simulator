###########################################################################
## Makefile generated for component 'Sensor_Fusion_ZP'. 
## 
## Makefile     : Ot0CAsNmzP502AtDFUhkED.mk
## Generated on : Sun Sep 24 13:45:24 2023
## Final product: .\IovTcWA0Yo4GEdC6k7ayQB.exe
...
PRODUCT_NAME              = Sensor_Fusion_ZP
MAKEFILE                  = Ot0CAsNmzP502AtDFUhkED.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\mahus\Desktop\WARG_NEW\ZP3-Simulator
TGT_FCN_LIB               = ISO_C
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = Ot0CAsNmzP502AtDFUhkED_comp.rsp
CMD_FILE                  = Ot0CAsNmzP502AtDFUhkED.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = .\IovTcWA0Yo4GEdC6k7ayQB.exe
...
OBJS = xil_interface_lib.obj xil_data_stream.obj xil_services.obj xilcomms_rtiostream.obj xil_rtiostream.obj rtiostream_utils.obj sil_main.obj target_io.obj rtiostream_tcpip.obj Ot0CAsNmzP502AtDFUhkED_interface.obj manhony_ahrs.obj sensor_fusion.obj
...
Ot0CAsNmzP502AtDFUhkED_interface.obj : "$(START_DIR)\slprj\_sloop\Ot0CAsNmzP502AtDFUhkED\Ot0CAsNmzP502AtDFUhkED_interface.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\slprj\_sloop\Ot0CAsNmzP502AtDFUhkED\Ot0CAsNmzP502AtDFUhkED_interface.cpp"


manhony_ahrs.obj : "$(START_DIR)\OUTPUT~1\..\SENSOR~1\Src\manhony_ahrs.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\OUTPUT~1\..\SENSOR~1\Src\manhony_ahrs.cpp"


sensor_fusion.obj : "$(START_DIR)\OUTPUT~1\..\SENSOR~1\Src\sensor_fusion.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\OUTPUT~1\..\SENSOR~1\Src\sensor_fusion.cpp"
